...
Page({
  ...
  onLoad(query){
    ...
    // 3) load product shelf by species (placeholder SKUs)
  ...
  goAI(){ const id=this.data.nowRecipe.recipe_id; tt.navigateTo({ url:`/pages/ai/form/index?id=${id}` }); }
});
